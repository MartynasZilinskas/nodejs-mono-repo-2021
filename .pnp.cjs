...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "dependencyTreeRoots": [
      ...
      {
        "name": "sample-lib-another",
        "reference": "workspace:packages/sample-lib-another"
      }
    ],
    "enableTopLevelFallback": true,
    "ignorePatternData": "(^(?:\\.yarn\\/sdks(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$)",
    "fallbackExclusionList": [
      ["nodejs-mono-repo-2021", ["workspace:."]],
      ["sample-lib", ["workspace:packages/sample-lib"]],
      ["sample-lib-another", ["workspace:packages/sample-lib-another"]]
    ],
    "fallbackPool": [
    ],
    "packageRegistryData": [
      ...
      ["sample-lib-another", [
        ["workspace:packages/sample-lib-another", {
          "packageLocation": "./packages/sample-lib-another/",
          "packageDependencies": [
            ["sample-lib-another", "workspace:packages/sample-lib-another"],
            ["sample-lib", "workspace:packages/sample-lib"],
            ["typescript", "patch:typescript@npm%3A4.4.2#~builtin<compat/typescript>::version=4.4.2&hash=d8b4e7"]
